...
class DetalheAperitivoFragment : Fragment() {
    private lateinit var binding: FragmentDetalheAperitivoBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentDetalheAperitivoBinding.inflate(inflater, container, false)
        return binding.root
    }
